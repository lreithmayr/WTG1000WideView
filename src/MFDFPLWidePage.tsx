...
/**
 * Component props for MFDFPLWidePage.
 */
export interface MFDFPLWidePageProps extends MFDUiPageProps {
    /** The event bus. */
    bus: EventBus;
 ...
 */
export class MFDFPLWidePage extends MFDUiPage<MFDFPLWidePageProps> {
    private static readonly UPDATE_FREQ = 30; // Hz
    private static readonly POINTER_MOVE_INCREMENT = 5; // pixels

    private readonly fplRef = FSComponent.createRef<MFDFPLWide>();
    ...
    /** @inheritdoc */
    constructor(props: MFDFPLWidePageProps) {
        super(props);
    ...
    private handleMapPointerMoveEvent(evt: FmsHEvent): boolean {
        ...
        switch (evt) {
            case FmsHEvent.JOYSTICK_LEFT:
                this.mapPointerController.movePointer(-MFDFPLWidePage.POINTER_MOVE_INCREMENT, 0);
                return true;
            case FmsHEvent.JOYSTICK_UP:
                this.mapPointerController.movePointer(0, -MFDFPLWidePage.POINTER_MOVE_INCREMENT);
                return true;
