...
import { MapBuilder } from '@microsoft/msfs-wtg1000';
import { MapUserSettings } from '@microsoft/msfs-wtg1000';
import { MapWaypointIconImageCache } from '@microsoft/msfs-wtg1000';
import { TrafficUserSettings } from '@microsoft/msfs-wtg1000';
import { FmsHEvent } from '@microsoft/msfs-wtg1000';
import { MFDPageMenuDialog } from '@microsoft/msfs-wtg1000';
 ...
 */
export class MFDNavMapWidePage extends MFDUiPage<MFDNavMapPageProps> {
    ...
    private readonly compiledMap = MapSystemBuilder.create(this.props.bus)
        .with(MapBuilder.navMap, {
            bingId: 'mfd-page-map',
            dataUpdateFreq: MFDNavMapWidePage.UPDATE_FREQ,
        ...
        .withProjectedSize(Vec2Math.create(727, 734))
        .withDeadZone(VecNMath.create(4, 0, 56, 0, 0))
        .withClockUpdate(MFDNavMapWidePage.UPDATE_FREQ)
    ...
    private readonly pageMenuItems = [
        ...
        {
            id: 'declutter',
            renderContent: (): VNode => <span>Declutter (Current Detail {MFDNavMapWidePage.DECLUTTER_TEXT[this.mapSettingManager.getSetting('mapDeclutter').value]})</span>,
            action: (): void => {
    ...
    private handleMapPointerMoveEvent(evt: FmsHEvent): boolean {
        ...
        switch (evt) {
            case FmsHEvent.JOYSTICK_LEFT:
                this.mapPointerController.movePointer(-MFDNavMapWidePage.POINTER_MOVE_INCREMENT, 0);
                return true;
            case FmsHEvent.JOYSTICK_UP:
                this.mapPointerController.movePointer(0, -MFDNavMapWidePage.POINTER_MOVE_INCREMENT);
                return true;
