...
import { NumberUnitDisplay } from '@microsoft/msfs-wtg1000';

/**
 * Represent the origin segment of a flight plan listing.
 */
export class FPLWideOrigin extends DisplayComponent<ComponentProps> {
  ...
  public render(): VNode {
    return (
      <div id="origDestWide" ref={this.origDestRef}>
